...
Source0  : https://github.com/qpdf/qpdf/releases/download/v11.6.3/qpdf-11.6.3.tar.gz
Source1  : https://github.com/qpdf/qpdf/releases/download/v11.6.3/qpdf-11.6.3.tar.gz.asc
...
%prep
%setup -q -n qpdf-11.6.3
cd %{_builddir}/qpdf-11.6.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707100870
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libqpdf.so.29.6.3
/usr/lib64/libqpdf.so.29
/usr/lib64/libqpdf.so.29.6.3
