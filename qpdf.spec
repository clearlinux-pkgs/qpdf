...
Source0  : https://github.com/qpdf/qpdf/releases/download/v11.9.0/qpdf-11.9.0.tar.gz
Source1  : https://github.com/qpdf/qpdf/releases/download/v11.9.0/qpdf-11.9.0.tar.gz.asc
...
%prep
%setup -q -n qpdf-11.9.0
cd %{_builddir}/qpdf-11.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710353083
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libqpdf.so.29.9.0
/usr/lib64/libqpdf.so.29
/usr/lib64/libqpdf.so.29.9.0
